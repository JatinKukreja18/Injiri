<?php
/*Template Name: Clothing Collection V3*/
get_header();
?>
	...
	foreach ($_terms as $term) :
		...
		<div class="col-lg-8 col-sm-12 offset-4 collection-spacer">
			<div class="row collection-set">
				<div class="col-lg-6 col-sm-6 collection-set-image v3">		
					<ul>
					<?php while ( $_posts->have_posts() ) : $_posts->the_post();$count++	;
					?>
						
						<li class="collection-thumbnail v3 collection-thumbnail-<?php echo  $term_slug ?> collection-thumbnail-<?php echo  $term_slug ?>-<?php echo  $count ?> <?php if($count ==1) echo 'active' ?>" >
								<?php the_post_thumbnail();?>
						</li>
					<?php
					endwhile;?>
					</ul>
					<div class=" collection-set-list v3">
