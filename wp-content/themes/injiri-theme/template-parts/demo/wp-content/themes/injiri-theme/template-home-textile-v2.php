<?php
/*Template Name: Home Textile Portrait*/
get_header();
?>
			...
			<div class="row collection-set">
				<div class="col-lg-6 col-sm-6 collection-set-image v2">		
					...
					?>
						...
						<li 
							class="collection-thumbnail collection-thumbnail-<?php echo  $term_slug ?> collection-thumbnail-<?php echo  $term_slug ?>-<?php echo  $count ?> 
...
<script>
	...
	// 	let allImages = document.querySelectorAll(".collection-thumbnail-home-textiles");
	...
	// 					changeThumbnail('home-textiles', nextIndex);
	...
	var slides = document.querySelectorAll('.collection-thumbnail-home-textiles');
	var links = document.querySelectorAll('.collection-link-home-textiles');
	var currentSlide = 0;
